    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row gap-5">
        ...
        <div className="card bg-base-100 w-96  shadow-xl">
          <figure>
            <img
              src='https://i.ibb.co.com/sP3DzvN/fea-11.jpg'
              alt="Shoes" className="h-96 rounded-md" />
          </figure>
        ...
        {/* end */}
         ...
         <div className="card bg-base-100 w-96 shadow-xl">
          <figure>
            <img
             src='https://i.ibb.co.com/dMyZFJJ/fea-22.jpg'
             alt="Shoes" className="h-96 rounded-md" />
          </figure>
          <div className="card-body">
            <h2 className="card-title">
        ...
        {/* end */}
         ...
         <div className="card bg-base-100 w-96 shadow-xl">
          <figure>
            <img
             src='https://i.ibb.co.com/XkbKJpF/fea-3.jpg'
             alt="Shoes" className="h-96 rounded-md" />
          </figure>
          <div className="card-body">
            <h2 className="card-title">
